...
import { Logger } from '@ovcernightjs/logger';
...
describe('DemoController', () => {
    ...
    describe('API: "/api/say-hello/:name"', () => {
        ...
        it(`should return a JSON object with the message "${message}" 
            and a status code of "${OK}" if message was successful`, done => {
        ...
        it(`should return a JSON object with the "error" param and 
            a status code of "${BAD_REQUEST}" if message failed`, done => {
